...
$DriverBillList = $aDriver->GetAllDriverBillPrint($_GET['user']);
...
<?php 
foreach($DriverBillList['DriverBill'] as $data){
?>
    ...
    <div class="row" style="padding:10px">
        <?php for($i=1; $i<=3; $i++){?>
            <div class="col-sm-4">
                ...
                <div>
                    <p style="font-size:15px; text-align: center; padding-top: 25px; color:black;">ইজিবাইক চালকের বিবিধ বিল:</p>
                    <?php 
                ...
                <div style="padding-top: 25px; color:black; line-height:180%;">
                    <table>
                        <tr>
                            <th>বিল নম্বর:</th>
                            <td><div class="invCardBillNo"><?php echo $data['cbl_code']?></div></td>
                        <!-- </tr>
                        <tr>
                        ...
                        <tr>
                            <th>চালকের  নাম:</th>
                            <td><div class="driverName"><?php echo $data['d_name']?></div></td>
                        </tr>
                        <tr>
                            <th>চালকের  আইডি:</th>
                            <td><div class="driverId"><?php echo $data['d_code']?></div></td>
                        </tr>
                        <tr>
                            <th>চালকের লাইসেন্স নম্বর :</th>
                            <td><div class="driverLicenseNo"><?php echo $data['d_license_no']?></div></td>
                        </tr>
                        <tr>
                            <th>অর্থ বছর:</th>
                        ...
                        <tr>
                            ...
                            <td><div class="invBillPayDateC"><?php echo $data['payment_date']?></div></td>
                        </tr>                                          
                    </table>
                </div>
                    ...
                    <table id="t02" style="width:100%">
                        <tr>
                            ...
                            <td style="width:40%; text-align: right; border: 1px solid black; border-collapse: collapse;"> 
                                <div class='bill1'><?php if($data['bill_type'] == 0 ) echo $data['card_fee']?></div>
                            </td>
                        </tr>
                        <tr>
                            <th style="border: 1px solid black; border-collapse: collapse;">সারচার্জ</th>
                            <td style="width:40%; text-align: right; border: 1px solid black; border-collapse: collapse;">
                            <div class='bill2'><?php if($data['bill_type'] == 1 ) echo $data['card_fee']?></div>
                            </td>
                        </tr>
                        <tr>
                            <th style="border: 1px solid black; border-collapse: collapse;">জরিমানা</th>
                            <td style="width:40%; text-align: right; border: 1px solid black; border-collapse: collapse;">
                                <div class='bill3'><?php if($data['bill_type'] == 2 ) echo $data['card_fee']?></div>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="width:40%; text-align: right; border: 1px solid black; border-collapse: collapse;">
                                <div class='billtotal'><?php echo $data['card_fee']?></div>
                            </td>
                        </tr>
                    </table>
                </div>
                ...
                <div style="padding-top: 30px; color:black;">
                    <table id="t03" style="width:100%">
                        ...
                        <tr>
                            <td style="padding: 8px; text-align: center; border: 1px solid black; border-collapse: collapse;"><?php echo $data['b_name']?></td>
                            <td style="padding: 8px; text-align: center; border: 1px solid black; border-collapse: collapse;"><?php echo $data['ac_branch']?></td>
                            <td style="padding: 8px; text-align: center; border: 1px solid black; border-collapse: collapse;"><?php echo $data['ac_no']?></td>
                        </tr>
                        </tr>
                    </table>
                </div>
