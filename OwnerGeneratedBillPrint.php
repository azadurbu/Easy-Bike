...
<div id="printableAreaPVC" style="width: 90%;">
<?php 
                ...
                <div style="padding-top: 25px; color:black; line-height:180%;">
                    <table>
                        <tr>
                            ...
                            <td><div class="invCardBillNo"><?php echo $data['bill_code']?></div></td>
                        </tr>
                        <tr>
                            <th>রেজিস্ট্রেশন নম্বর:</th>
                            <td><div class="invOwnerTrnsRegNoC"><?php echo $data['v_reg_no']?></div></td>
                        </tr>
                        <tr>
                            <th>মালিকের  নাম:</th>
                    ...
                    <table id="t02" style="width:100%">
                        <tr>
                            ...
                            <td style="width:40%; text-align: right; border: 1px solid black; border-collapse: collapse;">
                                <div class='bill1'><?php echo $data['reg_fee']?></div>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="width:40%; text-align: right; border: 1px solid black; border-collapse: collapse;"> 
                            <div class='billtotal'><?php echo $data['reg_fee']?></div>
                            </td>
                        </tr>
                    </table>
                </div>
