        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form method="get" target="_blank" action="Views/ReportView/rptOwner.php" name="frmOwnerRPT" id="frmOwnerRPT" data-parsley-validate class="form-horizontal form-label-left">
