						...
						<form  method="post" name="addVehicle" id="addVehicle" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
							...
							<div class="container">
									...
									<div class="col-sm-10">
										<table class="info-tab-cust">
											...
											<tr>
												...
												<td>
													<select class="form-group" id="Model" name="Model" required>
														...
														<option value="Easybike" selected>Easy Bike</option>
											...
											<tr>
												...
												<td> 
													<select class="form-control select2" searchable="Search here.."  name="Owner" id="Owner" required="required">
									...
									<div class="col-sm-12">
										<div class="card">
											<div class="cont">
												...
												<textarea class="form-group" rows="5" id="Detail" name="Detail" ></textarea>
											</div>
										</div>
									</div>	                          
								</div>
								...
								<div class="modal-footer">
									...
									<a onclick="document.getElementById('addVehicle').reset();" class="btn btn-danger pull-right">Clear</a>
								</div>
							</div>
						</form>	
			        </div>
