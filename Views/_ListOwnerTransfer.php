						...
						<div class="x_title">		
                            ...
                            <?php
                                if($Add)
                                 {
                            ?>
									<!-- <button data-toggle="modal" data-target="#AddOwnerTransferModal" type="button" class="btn btn-info">  মালিকানা পরিবর্তন করুন <i class="fa fa-plus-square"></i></button> -->
									<a href="AddOwnerTransfer.php" target="_blank" class="btn btn-info"> মালিকানা পরিবর্তন করুন <i class="fa fa-plus-square"></i></a>
                            <?php
                                 }
                            ?>
                                </ul>
							</ul>
							<a href="OwnerTransferBillPrint.php?user=1" target="_blank" class="btn btn-info"> মালিকানা পরিবর্তনের পরিশোধিত বিল <i class="fa fa-plus-square"></i></a>
                            <a href="OwnerTransferBillPrint.php?user=2" target="_blank" class="btn btn-info"> মালিকানা পরিবর্তনের অপরিশোধিত বিল <i class="fa fa-plus-square"></i></a>
                            <a href="OwnerTransferBillPrint.php?user=3" target="_blank" class="btn btn-info"> মালিকানা পরিবর্তনের সকল বিল <i class="fa fa-plus-square"></i></a>
							<div class="clearfix"></div>
						</div>
