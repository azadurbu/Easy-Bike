                                ...
                                <div class="col-sm-8">
                                    <table class="info-tab-cust">
                                        <tr>
                                            ...
                                            <td><input class="form-group" type="text" name="LicenseNo" id="LicenseNo" readonly></td>
                                        </tr> 
                                        <tr>
                                            <td>Exam Pass Date / Approveal Date<span> *</span></td>
                                            <td><input class="form-group" type="date" name="approvealDate" id="approvealDate"></td>
                                        </tr> 
                                        <tr>
                                            <td> চালকের নাম<span> *</span></td>
                                            <td><input class="form-group" type="text" name="DriverName" id="DriverName"></td>
                                        </tr> 
                                        <tr>
                                            <td> Driver Name (English)<span> *</span></td>
                                            <td><input class="form-group" type="text" name="DriverNameEng" id="DriverNameEng"> </td>
                                        </tr> 
                                        <tr>
                                            <td>মোবাইল নং<span> *</span></td>
                                            <td><input class="form-group" type="number" name="Mobile" id="Mobile"></td>
                                        </tr> 
                                        <tr>
                                            <td>পিতা/স্বামীর নাম<span> *</span></td>
                                            <td><input class="form-group" type="text" name="FathersName" id="FathersName"></td>
                                        </tr> 
                                        <tr>
                                            <td>মাতার নাম<span> *</span></td>
                                            <td><input class="form-group" type="text" name="MotherName" id="MotherName"></td>
                                        </tr> <tr>
                                            <td>জন্ম তারিখ<span> *</span></td>
                                            <td><input class="form-group" type="text" name="DOB" id="DOB" autocomplete="off"></td>
                                        </tr>
                                        <tr>
                                            <td>এনআইডি নম্বর<span> *</span></td>
                                            <td><input class="form-group" type="number" name="NID" id="NID"></td>
                                        </tr> 
                                        <tr>
                                            <td>রক্তের গ্রূপ</td>
                                            <td>
                                                <select class="form-group" name="DriverBGroup" id="DriverBGroup">
											...
											<tr>
												...
												<td>
													<div class="form-group">
														...
														<input class="form-control" type="text" name="cHoldingNo" id="cHoldingNo" required="required" required="required">
													</div>
												</td>
											</tr> 
										</table>
