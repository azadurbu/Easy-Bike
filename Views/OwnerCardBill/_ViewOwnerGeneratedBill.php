        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="clearfix"></div>
                    <form  method="post" name="viewOwnerGeneratedBill" id="viewOwnerGeneratedBill" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">  
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="Code" id="Code" required="required" readonly>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="OwnerFee" id="OwnerFee" required="required" readonly="readonly">
                        </div>
