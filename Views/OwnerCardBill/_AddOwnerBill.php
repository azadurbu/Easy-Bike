...
<!-- Modal -->
<div class="modal fade" id="AddOwnerCardBillModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        ...
        <form  method="post" name="addOwnerCardBill" id="addOwnerCardBill" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Add New Owner Bill</h4>
                </div>
