...
<!-- Modal -->
<div class="modal fade" id="AddDriverCardBillModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        ...
        <form  method="post" name="addDriverCardBill" id="addDriverCardBill" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Add New DriverBill</h4>
                </div>
