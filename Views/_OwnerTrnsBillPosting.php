...
<!-- Modal -->
<div class="modal fade" id="OwnerTrnsBillPostingModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        ...
        <form  method="post" name="OwnerTrnsPostBill" id="OwnerTrnsPostBill" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Owner Transfer Bill Posting</h4>
                </div>
