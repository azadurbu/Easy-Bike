...
<!-- Modal -->
<div class="modal fade" id="SubDivisionModalEdit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <form  method="post" name="editSubDivision" id="editSubDivision" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Edit Municipality</h4>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <input class="form-control" type="hidden" name="SubDivisionID" id="SubDivisionID" required="required" readonly="readonly">
