	...
	<div class="">
		<div class="page-title">
			<div class="title_left">
				<h3> ইজিবাইক মালিকের রেজিস্ট্রেশন ফর্ম </h3>
			</div>
		</div>
					...
					<form  method="post" name="addOwner" id="addOwner" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
						...
						<div class="container">
								...
								<div class="col-sm-8">
									<table class="info-tab-cust">
										...
										<tr> 
											<td>রক্তের গ্রূপ</td>
											<td>
											<select class="form-group" id="OwnerBGroup" name="OwnerBGroup" >
										...
										<div class="cont">
											...
											<table class="info-tab-cust">
												...
												<tr>
													...
													<td>
														<div class="form-group">
															<label for="HoldingNo"><span class=""></span></label>
							...
							<div class="modal-footer">
								...
								<a onclick="document.getElementById('addOwner').reset();" class="btn btn-danger pull-right">Clear</a>
							</div>
						</div>
					</form>	
				</div>	
