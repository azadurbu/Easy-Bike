...
<!-- Modal -->
<div class="modal fade" id="LocAreaAdd" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <form  method="post" name="addArea" id="addArea" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
            <div class="modal-content">

                 	<input type="hidden" name="DocType" id="DocType" value="ARA">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label  for="Area"> গ্রাম/মহল্লা <span class="required">*</span></label>
                        <input class="form-control" type="text" name="Area" id="Area" required="required">
                    </div>
