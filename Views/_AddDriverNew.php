						...
						<div class="container">
								...
								<div class="col-sm-4">
									<div class="owner-pic-info">
										<div class="myQRFrame">
											...
											height="350" width="350" onclick="imageOutput()"/>
										</div>    
									</div>
								</div>
								<div class="col-sm-8">
									<table class="info-tab-cust">
										<tr>
											...
											<td>
											<input class="form-control" type="text" name="LicenseNo" id="LicenseNo" required="required" readonly="">
												<!-- <input class="form-group" type="number" id="RegNo" autocomplete="off"> -->
											</td>
										</tr> 
										<tr>
											<td>Exam Pass Date / Approveal Date<span> *</span></td>
											<td><input class="form-group" type="text" id="approvealDate" name="approvealDate"></td>
										</tr> 
										<tr>
											<td> চালকের নাম<span> *</span></td>
											<td><input class="form-group" type="text" id="DriverName" name="DriverName"></td>
										</tr> 
										<tr>
											<td> Driver Name (English)<span> *</span></td>
											<td><input class="form-group" type="text" id="DriverNameEng" name="DriverNameEng"> </td>
										</tr> 
										<tr>
										...
										<tr>
											...
											<td><input class="form-group" type="text" id="FathersName" name="FathersName"></td>
										</tr> 
										<tr>
											...
											<td><input class="form-group" type="text" id="DOB" name="DOB" autocomplete="off"></td>
										</tr>
										<tr>
											...
											<td>রক্তের গ্রূপ</td>
											<td>
												<select class="form-group" id="DriverBGroup" name="DriverBGroup">
							...
							<div class="row">
										...
										<div class="cont">
											...
											<table class="info-tab-cust">
												...
												<tr>
													...
													<td>
														<div class="form-group">
															<label for="HoldingNo"><span class="required"></span></label>
															<input class="form-control" type="text" name="cHoldingNo" id="cHoldingNo" required="required">
														</div>
													</td>
												</tr> 
											</table>
								...
								<div class="col-sm-6">
									<div class="card">
										<div class="cont">
											<div><h4><b>স্থায়ী ঠিকানা	&nbsp;	&nbsp;</b><label for="Address"><span class="required"><input type="checkbox" name="chkAddress" id="chkAddress" onclick="CheckAddress()"> </span><span>একই</span> </label>
											</h4>
											</div>
							...
							<div class="modal-footer">
								...
								<a onclick="document.getElementById('addDriver').reset();" class="btn btn-danger pull-right">Clear</a>
							</div>
						</div>	
					</form>	
				</div>	
