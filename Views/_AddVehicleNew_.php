	   		...
	   		<div class="row">
				...
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="x_panel">
						...
						<form  method="post" name="addVehicle" id="addVehicle" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<select class="selectpicker" data-live-search="true" name="Owner" id="Owner" class="form-control" required="required">	
							...
							<div class="form-group">
								...
								<input class="form-control" type="text" name="Model" id="Model" required="required" value="ইজি বাইক" readonly>
							</div>
					
							<div class="form-group">
								<label for="Color">গাড়ীর রঙ <span class="required">*</span></label>
								<input class="form-control" type="text" name="Color" id="Color" required="required" value="হলুদ" readonly>
							</div>
