...
<div class="modal fade" id="DeleteUserModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <form  method="post" name="deleteUser" id="deleteUser" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <input class="form-control" type="hidden" name="UserID" id="UserID" value="" required="required" readonly>
