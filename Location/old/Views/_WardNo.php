            ...
            <div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <form action=""  method="post" name="" id="" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
						...
						<div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12" for="Division">ওয়ার্ড নং <span class="required"> *</span></label>
							<div class="col-md-6 col-sm-6 col-xs-12">
