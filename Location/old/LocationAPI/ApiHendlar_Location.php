	...
	if(isset($_REQUEST))
	{
		...
		if($authorized->API_KEY()) // Check Authorization
		{
			if(isset($_REQUEST["action"]))
			{
				...
				else if($_REQUEST["action"] == 'InsertDivision') // INSERT OWNER
				{
					$data = json_decode( file_get_contents( 'php://input' ), true );
				...
				else if($_REQUEST["action"] == 'UpdateDivision') // INSERT OWNER
				{
					$data = json_decode( file_get_contents( 'php://input' ), true );
				...
				else if($_REQUEST["action"] == 'DeleteDivision') // INSERT OWNER
				{
					$data = json_decode( file_get_contents( 'php://input' ), true );
