...
$OwnerBillList = $aOwner->GetAllOwnerBillPrint($_GET['user']);
?>
                ...
                <div style="padding-top: 25px; color:black; line-height:180%;">
                    <table>
                        <tr>
                            ...
                            <td><div class="invCardBillNo"><?php echo $data['ocbl_code']?></div></td>
                        </tr>
                        <tr>
                            <th>রেজিস্ট্রেশন নম্বর:</th>
                            <td><div class="invOwnerTrnsRegNoC"><?php echo $data['v_code']?></div></td>
                        </tr>
                        <tr>
                            <th>মালিকের  নাম:</th>
                        ...
                        <tr>
                            <th>মালিকের  আইডি:</th>
                            <td><div class="invOwnerIdNoC"><?php echo $data['o_code']?></div></td>
                        </tr>
                        <tr>
                            <th>অর্থ বছর:</th>
                        ...
                        <tr>
                            ...
                            <td><div class="idate"><?php echo $data['issue_date']?></div></td>
                        </tr>
                        <tr>
                    ...
                    <table id="t02" style="width:100%">
                        <tr>
                            ...
                            <td style="width:40%; text-align: right; border: 1px solid black; border-collapse: collapse;">
                                <div class='bill1'><?php if($data['bill_type'] == 0 ) echo $data['o_card_fee']?></div>
                            </td>
                        </tr>
                        <tr>
                            <th style="border: 1px solid black; border-collapse: collapse;">সারচার্জ</th>
                            <td style="width:40%; text-align: right; border: 1px solid black; border-collapse: collapse;">
                                <div class='bill2'><?php if($data['bill_type'] == 1 ) echo $data['o_card_fee']?></div>
                            </td>
                        </tr>
                        <tr>
                            <th style="border: 1px solid black; border-collapse: collapse;">জরিমানা</th>
                            <td style="width:40%; text-align: right; border: 1px solid black; border-collapse: collapse;">
                                <div class='bill3'><?php if($data['bill_type'] == 2 ) echo $data['o_card_fee']?></div>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="width:40%; text-align: right; border: 1px solid black; border-collapse: collapse;"> 
                            <div class='billtotal'><?php echo $data['o_card_fee']?></div>
                            </td>
                        </tr>
                    </table>
                </div>
