			...
			<!-- sidebar menu -->
				...
				?>
								<li><a><i class="fa fa-usd"></i> বিল <span class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
                                        ...
                                        <li><a href="./OwnerCardBill.php">মালিকের কার্ড বিল </a></li>
										<li><a href="./DriverCardBill.php">চালকের কার্ড বিল</a></li>
									</ul>
								</li>
				<?php
					}
				...
				?>
								<li><a><i class="fa fa-gear"></i> প্রাথমিক সেটআপ <span class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										...
										<li><a href="./OwnerTransferFee.php"> মালিকানা পরিবর্তনের ফি </a></li>
										<li><a href="./OwnerCardFee.php"> মালিকের কার্ড ফি </a></li>
										<li><a href="./DriverCardFee.php"> চালকের কার্ড ফি </a></li>
				...
				?>	
								<li><a ><i class="fa fa-university"></i> ব্যাংক <span class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										<li><a href="./SetBank.php">সকল ব্যাংকের তালিকা </a></li>
										<li><a href="./SetAccount.php">সকল একাউন্টের তালিকা </a></li>
									</ul>
								</li>
				<?php
					}
