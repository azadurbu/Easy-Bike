...
<html lang="en">
  <head>
	...
	<link rel="icon" href="images/favicon_01.ico" type="image/ico" />
 ...
 <!--    <link href="./Custom/UserJsCss/CSS/userStyle.css" rel="stylesheet"> -->
    ...
    <link href="./Custom/CSS/print.css" rel="stylesheet">
    <link href="./Custom/CSS/select.css" rel="stylesheet">
    <link href="./Custom/CSS/spin.css" rel="stylesheet">
...
<!--     <link href="./Theme/vendors/nprogress/nprogress.css" rel="stylesheet"> -->
    <!-- iCheck -->
	 ...
	 <link href="./Theme/vendors/iCheck/skins/flat/red.css" rel="stylesheet"> 
...
<link href="./Custom/CSS/myCustom.css" rel="stylesheet">


<link rel="stylesheet" type="text/css" href="./Custom/CSS/jquery.datetimepicker.css" >
